...
var _default = function () {
  var _ref = _asyncToGenerator(function* (sessionToken, profile, providerAccount, options) {
        ...
        if (userByProviderAccountId) {
          if (isSignedIn) {
            if ("".concat(userByProviderAccountId.id) === "".concat(user.id)) {
              user = yield updateUserAndDispatchEvent(updateUser, events, profile, user.id);
              return {
                session,
                user,
                isNewUser
            ...
            user = yield updateUserAndDispatchEvent(updateUser, events, profile, userByProviderAccountId.id);
            return {
              session,
              user,
              isNewUser
    ...
    function _updateUserAndDispatchEvent() {
      _updateUserAndDispatchEvent = _asyncToGenerator(function* (updateUserFunction, events, profile, userId) {
        var user = yield updateUserFunction(_objectSpread(_objectSpread({}, profile), {}, {
          id: userId
        }));
